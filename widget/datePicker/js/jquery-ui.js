...
(function($, undefined) {
	function isArray(a) {
		return a && ($.support.safari && typeof a == "object" && a.length || a.constructor && a.constructor.toString().match(/\Array\(\)/))
	}
	...
	$.extend(Datepicker.prototype, {
		...
		_showDatepicker: function(a) {
			...
			if (!$.datepicker._isDisabledDatepicker(a) && $.datepicker._lastInput != a) {
				...
				$(a).parents().each(function() {
					...
					return !e
				}), e && $.support.opera && ($.datepicker._pos[0] -= document.documentElement.scrollLeft, $.datepicker._pos[1] -= document.documentElement.scrollTop);
				var f = {
		...
		_generateHTML: function(a) {
			...
			K += x + ($.support.msie && parseInt($.support.version, 10) < 7 && !a.inline ? '<iframe src="javascript:false;" class="ui-datepicker-cover" frameborder="0"></iframe>' : ""),
				a._keyEvent = !1;
			return K
		},
